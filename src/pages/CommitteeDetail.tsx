...
export function CommitteeDetail() {
            ...
            <div className="min-h-screen pt-16 bg-white flex items-center justify-center">
                <div className="text-center">
                    ...
                    <Button
                        ...
                        variant="outline"
                        className="text-[#2b174f] border-[#2b174f] hover:bg-[#2b174f]! hover:text-white! transition-colors duration-200"
                    >
    ...
    return (
        <div className="min-h-screen pt-16 bg-white">
            {/* Navigation */}
            <div className="bg-white border-b border-gray-100 py-4 sticky top-16 z-50">
            ...
            <section className="relative py-16 overflow-hidden bg-[#2b174f]">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="flex items-start justify-between gap-6 mb-8">
                        <div>
                            <span
                                className="bg-[#2b174f] text-[#f2b652] text-xs font-bold px-4 py-2 rounded-sm tracking-widest uppercase inline-block mb-4">
            ...
            {committee.chairs && committee.chairs.length > 0 && (
                <section className="py-16">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div
                            className={`grid grid-cols-1 gap-8 ${committee.chairs.length > 1 ? "md:grid-cols-2" : ""}`}>
                            {committee.chairs.map((chair, index) => (
                                ...
                                >
                                    <div className="h-72 bg-linear-to-br from-[#2b174f] to-[#6d28d9] overflow-hidden">
                                        {chair.imageUrl ? (
                                            <img
                                                src={chair.imageUrl}
                                                alt={chair.name}
                                            ...
                                            <div className="w-full h-full flex items-center justify-center">
                                                <div className="text-center">
                                                    <div
                                                        className="w-24 h-24 rounded-full border border-white/15 bg-white/10 flex items-center justify-center mx-auto mb-3">
                    ...
                    <div className="flex gap-4 flex-wrap">
                        {committee.backgroundGuideUrl === "CONFIDENTIAL" ? (
                            ...
                            <Button
                                asChild
                                variant="outline"
                                className="border-[#2b174f] text-[#2b174f] hover:text-white! hover:bg-[#2b174f]! transition-colors duration-200 tracking-wider text-sm font-semibold uppercase w-full sm:w-auto"
                            >
                        ...
                        <Button asChild
                                className="w-full sm:w-auto bg-[#f2b652] text-[#2b174f] hover:bg-[#f2b652]/90 tracking-wider text-sm font-semibold uppercase">
            ...
            {/* Related Committees */}
            <section className="py-16 bg-[#f2b652]">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        {committees
                            ...
                            .map((c) => (
                                ...
                                >
                                    <Card
                                        className="bg-white border border-gray-100 hover:border-[#f2b652]/60 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 h-full cursor-pointer"
                                    >
                                        <CardHeader className="pb-3 pt-6 px-6">
                                            <div className="flex items-start justify-between gap-2 mb-2">
                                                <span
                                                    className="bg-[#2b174f] text-[#f2b652] text-xs font-bold px-2.5 py-1 rounded-sm tracking-widest uppercase">
                                                    {c.abbreviation}
                                                </span>
                                                <span
                                            ...
                                            <h3 className="text-[#2b174f] font-bold text-base leading-snug">
                                                {c.name}
                                            </h3>
                                        </CardHeader>
