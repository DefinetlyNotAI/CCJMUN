...
export function CommitteeDetail() {
    ...
    if (!committee) {
        return (
            <div className="min-h-screen pt-16 bg-[#7c3aed] flex items-center justify-center">
                <div className="text-center">
                    <h1 className="text-3xl font-bold text-white mb-4">Committee Not Found</h1>
                    <Button
                        onClick={() => navigate("/committees")}
                        variant="outline"
                        className="text-[#f2b652] border-[#f2b652] hover:bg-[#f2b652] hover:text-[#6d28d9]"
                    >
    ...
    return (
        <div className="min-h-screen pt-16 bg-[#7c3aed]">
            {/* Navigation */}
            <div className="bg-[#6d28d9] border-b border-purple-700 py-4 sticky top-16 z-10">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <button
                        onClick={() => navigate("/committees")}
                        className="flex items-center gap-2 text-[#f2b652] hover:text-white transition-colors font-semibold uppercase tracking-wider text-sm"
                    >
            ...
            <section className="relative py-16 overflow-hidden">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-start justify-between gap-6 mb-8">
                        <div>
                            <span className="bg-[#6d28d9] text-[#f2b652] text-xs font-bold px-4 py-2 rounded-sm tracking-widest uppercase inline-block mb-4">
            ...
            {/* Topics Section */}
            <section className="py-12 bg-white/5 border-y border-purple-600">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <h2 className="text-2xl font-bold text-white mb-8">Discussion Topics</h2>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <Card className="bg-white border-purple-200 hover:border-[#f2b652]/40 transition-colors">
                            <CardContent className="pt-6">
                                <div className="flex gap-3">
                                    <ChevronRight className="size-5 text-[#f2b652] shrink-0 mt-0.5" />
                                    <div>
                                        <h3 className="font-semibold text-[#6d28d9] mb-2">Topic 1</h3>
                            ...
                            <Card className="bg-white border-purple-200 hover:border-[#f2b652]/40 transition-colors">
                                <CardContent className="pt-6">
                                    <div className="flex gap-3">
                                        <ChevronRight className="size-5 text-[#f2b652] shrink-0 mt-0.5" />
                                        <div>
                                            <h3 className="font-semibold text-[#6d28d9] mb-2">Topic 2</h3>
            ...
            {/* Actions Section */}
            <section className="py-12 bg-white/5 border-t border-purple-600">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex gap-4 flex-wrap">
                        {committee.backgroundGuideUrl === "CONFIDENTIAL" ? (
                            ...
                            <a href={committee.backgroundGuideUrl} download>
                                <Button
                                    className="border-[#f2b652] text-[#f2b652] hover:bg-[#f2b652] hover:text-[#6d28d9] tracking-wider text-sm font-semibold uppercase"
                                    variant="outline"
                                >
                                    <Download className="size-4 mr-2" />
                        ...
                        <Link to="/registration">
                            <Button
                                className="bg-[#f2b652] text-[#6d28d9] hover:bg-[#f2b652]/90 tracking-wider text-sm font-semibold uppercase"
                            >
            ...
            <section className="py-16">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <h2 className="text-2xl font-bold text-white mb-8">Other Committees</h2>
                        ...
                        {committees
                            ...
                            .map((c) => (
                                <Link
                                    ...
                                    className="group"
                                >
                                    <Card className="bg-white border-purple-200 hover:border-[#f2b652]/40 hover:shadow-lg transition-all duration-300 h-full cursor-pointer">
                                        <CardHeader className="pb-3 pt-6 px-6">
                                            <div className="flex items-start justify-between gap-2 mb-2">
                                                <span className="bg-[#6d28d9] text-[#f2b652] text-xs font-bold px-2.5 py-1 rounded-sm tracking-widest uppercase">
                                                    {c.abbreviation}
                                                </span>
                                                <span
                                            ...
                                            <h3 className="text-[#6d28d9] font-bold text-base leading-snug group-hover:text-[#f2b652] transition-colors">
                                                {c.name}
                                            </h3>
                                        </CardHeader>
                                        <CardContent className="px-6 pb-6">
